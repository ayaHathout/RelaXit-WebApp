        ...
        <div class="profile-container">
            ...
            <div id="profileView" class="profile-section active">
                <div class="profile-avatar">
                    <img src="${pageContext.request.contextPath}/images/${user.profileImage != null && !user.profileImage.isEmpty() ? user.profileImage : 'assets/img/default-avatar.png'}" alt="Profile Image">
                </div>
            ...
            <form id="profileEditForm" class="profile-section" action="${pageContext.request.contextPath}/profile" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="avatar-upload-group">
                        ...
                        <label for="editProfileImage" class="avatar-upload-label">
                            <div class="avatar-preview">
                                <img src="${pageContext.request.contextPath}/images/${user.profileImage != null && !user.profileImage.isEmpty() ? user.profileImage : 'assets/img/default-avatar.png'}" 
                                     alt="Profile Preview" 
                ...
                <div class="form-actions">
                    <button type="submit" class="luxury-btn"><i class="fas fa-save"></i> Save Changes</button>
